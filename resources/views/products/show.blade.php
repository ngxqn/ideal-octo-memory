        ...
        <div id="product-content">
            <div class="product-detail">
                <div class="m-card p-0 overflow-hidden text-center mb-0" style="border-width: 1px;">
                    <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}" class="w-100 h-100 object-fit-cover" onerror="this.onerror=null;this.src='{{ asset('storage/products/default.png') }}'">
                </div>
                        ...
                        @foreach($relatedProducts as $related)
                            <div class="related-product-card position-relative">
                                ...
                                <a href="{{ route('products.show', $related->id) }}" class="text-decoration-none color-inherit">
                                    <img src="{{ asset('storage/' . $related->image) }}" alt="{{ $related->name }}" class="w-100 object-fit-cover rounded-3 mb-3" onerror="this.onerror=null;this.src='{{ asset('storage/products/default.png') }}'">
